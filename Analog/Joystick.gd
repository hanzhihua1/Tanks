...
var joystick_ring;
# the last stick vector for comparison
var last_stick_vector

func _ready():
	# This code will only run in game!
	if (Engine.editor_hint == false):	
		# Get the inner ring
		joystick_ring = get_node("Joystick_Nub")
...
func _process(delta):
	if joystick_active and joystick_vector != last_stick_vector:
		#print(name + " " + "Vector: " + String(joystick_vector))
		pass
	last_stick_vector = joystick_vector
